...
PS: в этой задаче обратите внимание на формат ввода.
    Числа вводятся в одну строку, поэтому вы уже не можете их так считать:

    n = int(input())
    a = int(input())
    b = int(input())

Возникнет ошибка! Чтобы считать три значения, которые поступают через пробел в  одной строке пользуйтесь
